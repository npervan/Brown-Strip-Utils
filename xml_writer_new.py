...
if __name__ == '__main__':
    ...
    for filename in filelist:
        if ".txt" in filename:
            if "interstrip" in filename:
                xml_writer(filename, 'CIS')
                xml_writer(filename, 'RIS')
            else:
                xml_writer(filename, 'PHS')
                xml_writer(filename, 'RS')
                xml_writer(filename, 'CS')
                xml_writer(filename, 'IS')
